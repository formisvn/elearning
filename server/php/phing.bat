...
SET phpCli=C:\Users\Mikko FORMIS\Documents\FORMIS II\Training\Moodle\server\php\.\php.exe
...
"%phpCli%" -d html_errors=off -qC "C:\Users\Mikko FORMIS\Documents\FORMIS II\Training\Moodle\server\php\pear\phing.php" %*
GOTO :EOF
